...
public final class StdAudio {
    ...
    private static AudioInputStream getAudioInputStreamFromFile(String filename) {
        ...
        try {
            ...
            InputStream is1 = edu.princeton.cs.algs4.StdAudio.class.getResourceAsStream(filename);
            if (is1 != null) {
                return AudioSystem.getAudioInputStream(is1);
            }

            // resource relative to classloader root
            InputStream is2 = edu.princeton.cs.algs4.StdAudio.class.getClassLoader().getResourceAsStream(filename);
            if (is2 != null) {
